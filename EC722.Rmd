...
reg1990 <- glm(INDBIN ~ INCEARN + OWNERSHIP + LIT + YRSCHOOL + NCHILD + FAMSIZE, data = train1990, family = binomial(link = logit))
summary(reg1990)
...
reg2000 <- glm(INDBIN ~ INCEARN + OWNERSHIP + LIT + YRSCHOOL + NCHILD+ FAMSIZE, data = train2000, family = binomial(link = logit))
summary(reg2000)
...
reg2010 <- glm(INDBIN ~ INCEARN + OWNERSHIP + LIT + YRSCHOOL + NCHILD + FAMSIZE, data = train2010, family = binomial(link = logit))
summary(reg2010)
